...
public class ReviewRepository {
	...
	public ReviewRepository() {
		Review barreThree = new Review(1L, "Barre3", "A combination of ballet, yoga, and pilates", "./barre3.png",
				"https://barre3.com/", "Fitness",
		...
		Review butcherShop = new Review(2L, "The ButcherShop Fitness", "Lagree fitness, pilates on a MegaFormer",
				"./lagree.jpg", "https://www.butchershopfitness.com/", "Fitness",
		...
		Review sos = new Review(3L, "System of Strength", "Various workout classes that range from HIIT to yoga",
